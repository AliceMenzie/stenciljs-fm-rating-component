...
const uiButtonCss = "@import url('https://fonts.googleapis.com/css2?family=Overpass:wght@400;/*!@700&display=swap')*/700&display=swap').sc-ui-button; button.sc-ui-button{font-family:'Overpass', sans-serif;background-color:hsl(25, 97%, 53%);color:hsl(0, 0%, 100%);height:45px;width:279px;border-radius:30px;border:none;text-transform:uppercase}/*!@button:hover*/button.sc-ui-button:hover{background-color:hsl(0, 0%, 100%);color:hsl(25, 97%, 53%)}";
...
class UiButton {
  ...
  render() {
    return (hAsync(Host, null, hAsync("button", { type: this.type, class: `${this.appearance}` }, this.label, hAsync("slot", null))));
  }
...
class UiCard {
  ...
  render() {
    ...
    if (this.submitted) {
      return (hAsync("div", { class: "card-container-back" }, hAsync("img", { src: this.imageBack, alt: "form submission illustration" }), hAsync("div", { class: "pill" }, "You selected out ", this.selectValue, " of 5"), hAsync("div", { class: "card-containter-back-content" }, hAsync("h2", null, "Thank you!"), hAsync("p", null, "We appreciate you taking the time to give a rating. If you ever need more support, don\u2019t hesitate to get in touch!"))));
    }
    else {
      return (hAsync("div", { class: "card-container" }, hAsync("div", { class: "image-container" }, hAsync("img", { src: this.imageFront, alt: "star" })), hAsync("div", { class: "content" }, hAsync("h3", null, "How did we do?"), hAsync("p", null, "Please let us know how we did with your support request. All feedback is appreciated to help us improve our offering!")), hAsync("div", { class: "form" }, hAsync("div", null, hAsync("ui-input", { type: "button", value: "1", active: this.selectValue === '1' ? 'true' : 'false', onClick: () => (this.selectValue = '1') }, "1"), hAsync("ui-input", { type: "button", value: "2", active: this.selectValue === '2' ? 'true' : 'false', onClick: () => (this.selectValue = '2') }, "2"), hAsync("ui-input", { type: "button", value: "3", active: this.selectValue === '3' ? 'true' : 'false', onClick: () => (this.selectValue = '3') }, "3"), hAsync("ui-input", { type: "button", value: "4", active: this.selectValue === '4' ? 'true' : 'false', onClick: () => (this.selectValue = '4') }, "4"), hAsync("ui-input", { type: "button", value: "5", active: this.selectValue === '5' ? 'true' : 'false', onClick: () => (this.selectValue = '5') }, "5")), hAsync("ui-button", { type: "submit", label: "submit", onClick: this.handleSubmit }))));
    }
  }
  static get style() { return uiCardCss; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "ui-card",
    "$members$": {
      "imageFront": [1, "image-front"],
      "imageBack": [1, "image-back"],
      "selectValue": [32],
      "submitted": [32]
    },
    "$listeners$": undefined,
...
const uiInputCss = "@import url('https://fonts.googleapis.com/css2?family=Overpass:wght@400;/*!@700&display=swap')*/700&display=swap').sc-ui-input; input[type='button'].sc-ui-input{font-family:'Overpass', sans-serif;background-color:hsl(213, 19%, 18%);color:hsl(216, 12%, 54%);border:none;height:42px;width:42px;border-radius:50%}/*!@input[type='button']:hover*/input[type='button'].sc-ui-input:hover{background-color:hsl(25, 97%, 53%);color:hsl(0, 0%, 100%)}/*!@.active*/.active.sc-ui-input{background-color:hsl(216, 12%, 54%) !important;color:hsl(0, 0%, 100%) !important}";
...
class UiInput {
  ...
  render() {
    return hAsync("input", { class: `${this.active === 'true' ? 'active' : ''}`, value: this.value, type: this.type });
  }
  static get style() { return uiInputCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "ui-input",
    "$members$": {
